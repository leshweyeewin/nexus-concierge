...
with tab_dag:
    ...
    digraph G {
        ...
        orch    [label="NexusOrchestrator\n(gemini-3.1-flash-lite)", fillcolor="#0d1b2a", fontcolor="#90CDF4",  color="#1A365D"];
        dev     [label="DevRelopsAgent\n(gemini-3.1-flash-lite)",    fillcolor="#0a2318", fontcolor="#68D391",  color="#22543D"];
        trading [label="QuantitativeRiskAgent\n(gemini-3.1-flash-lite)", fillcolor="#1f1600", fontcolor="#FBD38D", color="#744210"];
        tiktok  [label="CreativeAffiliateAgent\n(gemini-3.1-flash-lite)", fillcolor="#1a0f30", fontcolor="#D6BCFA", color="#5C3C92"];
